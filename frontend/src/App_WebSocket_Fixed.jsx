...
function App() {
  ...
  const setupVideoProcessing = (stream) => {
    ...
    try {
      ...
      console.log('✅ Video canvas created');
      ...
      const startVideoCapture = () => {
        ...
        const captureVideoFrame = () => {
          ...
          // Capture frame every 30 frames (roughly 1 FPS if called at 30 FPS)
          if (frameCount % 30 === 0) {
            try {
              ...
              if (videoRef.current.readyState >= 2) { // HAVE_CURRENT_DATA
                ...
                console.log(`🎥 Capturing video frame ${Math.floor(frameCount/30)}, size: ${frameData.length} bytes`);
      ...
      // Wait for video element to be ready, then start capture
